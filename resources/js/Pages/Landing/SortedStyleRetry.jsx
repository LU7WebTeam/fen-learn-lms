                ...
                <div className={`w-full rounded-2xl px-6 py-4 text-white shadow-[0_18px_45px_-28px_rgba(0,0,0,0.9)] backdrop-blur-md transition-colors duration-300 sm:px-7 ${isScrolled ? 'bg-[linear-gradient(135deg,rgba(255,138,0,0.88),rgba(255,179,102,0.84))]' : 'bg-black/30'}`}>
                    <div className="flex items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-3 text-sm font-semibold">
                            ...
                            {auth?.user ? (
                                <Link href={route('dashboard')} className="inline-flex min-w-[132px] items-center justify-center rounded-full bg-[#b53391] px-4 py-2 font-['Inter',sans-serif] text-[1rem] font-semibold text-white transition hover:bg-[#9f2c80] sm:min-w-[160px] sm:px-5 sm:py-2.5">
