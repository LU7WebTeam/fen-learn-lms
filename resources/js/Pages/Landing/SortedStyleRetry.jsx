...
export default function SortedStyleRetry() {
                    ...
                    <div className="flex items-center justify-between gap-3">
                        <div className="flex items-center gap-6">
                            ...
                            <nav className="hidden items-center gap-5 text-sm font-semibold lg:flex">
                                ...
                                <a href="#features" className="opacity-80 transition hover:opacity-100">{t('landing.nav.why_fen')}</a>
                        ...
                        <div className="flex items-center gap-3 text-sm font-semibold">
                            ...
                            {auth?.user ? (
                                <Link href={route('dashboard')} className="inline-flex min-w-[132px] items-center justify-center rounded-full bg-[#b53391] px-4 py-2 font-['Inter',sans-serif] text-[0.95rem] text-white transition hover:bg-[#9f2c80] sm:min-w-[160px] sm:px-5 sm:py-2.5 sm:text-[1.2rem]">
                                ...
                                <>
                                    ...
                                    <Link href={route('register')} className="inline-flex min-w-[132px] items-center justify-center rounded-full bg-[#b53391] px-4 py-2 font-['Inter',sans-serif] text-[0.95rem] text-white transition hover:bg-[#9f2c80] sm:min-w-[160px] sm:px-5 sm:py-2.5 sm:text-[1.2rem]">
                    ...
                    <div className="relative z-10 flex min-h-[70vh] w-full items-end px-6 pb-8 pt-[100px] sm:px-8 sm:pb-12 lg:px-10">
                        <div className="max-w-full sm:max-w-[70%]">
                            ...
                            <div className="mt-7">
                                <Link
                                    href={route('register')}
                                    className="inline-flex min-w-[160px] items-center justify-center rounded-full bg-[#b53391] px-5 py-2.5 font-['Inter',sans-serif] text-[1rem] text-white transition hover:bg-[#9f2c80] sm:text-[1.2rem]"
                                >
                ...
                <section id="proaktif" className="mt-4 space-y-4 rounded-xl bg-[#ebedf1] p-4 scroll-mt-24 sm:p-5">
                    <div className="grid gap-4 lg:grid-cols-12">
                        ...
                        >
                            ...
                            <h2 className="mt-2 font-['Young_Serif',serif] text-4xl leading-[0.95] text-[#131722] sm:text-5xl">
                                {t('landing.spotlight.title')}
                            </h2>
                            <h4 className="mt-5 font-['Young_Serif',serif] text-2xl leading-tight text-[#2a3140] sm:text-3xl">
                            ...
                            <div className="mt-6 flex flex-wrap gap-3">
                                <Link
                                    href={route('register')}
                                    className="inline-flex min-w-[160px] items-center justify-center gap-2 rounded-full bg-[#b53391] px-5 py-2.5 font-['Inter',sans-serif] text-[1rem] text-white transition hover:bg-[#9f2c80] sm:text-[1.2rem]"
                                >
                                ...
                                <Link
                                    ...
                                    className="inline-flex min-w-[160px] items-center justify-center gap-2 rounded-full bg-[#0353a1] px-5 py-2.5 font-['Inter',sans-serif] text-[1rem] text-white transition hover:bg-[#024180] sm:text-[1.2rem]"
                                >
                    ...
                    <section id="features" className="space-y-4 scroll-mt-24">
                        <div className="grid gap-4 lg:grid-cols-4">
                            ...
                            >
                                <h3 className="mt-2 font-['Young_Serif',serif] text-4xl leading-[0.95] text-white sm:text-5xl">
                    ...
                    <section
                        className="!mt-10 rounded-xl p-4 sm:p-5"
                        style={{
                            background:
                    ...
                    >
                        <div className="grid items-center gap-5 border-b border-white/25 pb-4 md:grid-cols-[1fr,260px]">
                            <div>
                                <h2 className="font-['Young_Serif',serif] text-4xl text-white sm:text-5xl">{t('landing.features.title')}</h2>
                            ...
                            {FEATURE_ITEMS.map((item, i) => {
                                ...
                                return (
                                    <article key={item.titleKey} className="card-raise anim-card overflow-hidden rounded-xl bg-white p-6" style={{ animationDelay: `${i * 100}ms` }}>
                                        ...
                                        <h3 className="mt-4 font-['Young_Serif',serif] text-2xl leading-tight text-[#1a1f2b]">
                                            {t(item.titleKey)}
                                        </h3>
                    ...
                    <section id="faq" className="!mt-10 scroll-mt-24">
                        <div className="grid gap-4 lg:grid-cols-12">
                            ...
                            >
                                <h2 className="mt-2 font-['Young_Serif',serif] text-4xl leading-[0.95] text-white sm:text-5xl">
                                    {t('landing.faq.title')}
                                </h2>
                                    ...
                                    {FAQ_ITEMS.map((item) => (
                                        ...
                                        >
                                            <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-4 py-4">
                                                <span className="font-['Young_Serif',serif] text-xl leading-tight text-[#1a1f2b]">
                                                    {t(item.qKey)}
                                                </span>
