            ...
            <div className="rounded-xl bg-white shadow-sm ring-1 ring-black/5 dark:bg-[#111827] dark:ring-white/10">
                <Link href={route('courses.show', course.slug)} className="block overflow-hidden rounded-xl">
                    ...
                    <div className="space-y-1.5 p-3">
                        ...
                        <p className="line-clamp-2 font-['Inter',sans-serif] text-base font-extrabold leading-snug text-[#131722] dark:text-slate-100">{courseTitle}</p>
                        {courseDescription && (
                ...
                <div className="py-2">
                    {course.sections.map((section) => (
                        <div key={section.id} className="mb-1">
                            <p className="px-4 pt-3 pb-1 font-['Inter',sans-serif] text-xs font-extrabold uppercase tracking-wider text-[#9ca3af] dark:text-slate-400">
