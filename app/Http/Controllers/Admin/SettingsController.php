...
class SettingsController extends Controller
{
    private array $defaults = [
        ...
        'reset_email_body'           => 'Do you want to reset your password? Click the button below to reset your password.',
        ...
        'reset_email_body_bm'           => 'Anda ingin tetapkan semula kata laluan anda? Klik butang di bawah untuk tetapkan semula kata laluan anda.',
        ...
        'two_factor_email_body'      => 'Do you want to log in to your account? Use the verification code below to log in.',
        ...
        'two_factor_email_body_bm'      => 'Anda ingin log masuk ke akaun anda? Gunakan kod pengesahan di bawah untuk log masuk.',
    ...
    public function testTemplateEmail(Request $request, string $type): RedirectResponse
    {
        ...
        try {
            ...
            if ($type === 'invitation') {
                ...
                $emailTitle = EmailContent::resolveSecondaryEnglish($emailTitle, $emailTitleBM, "You're invited to join the team", $tokens);
            ...
            if ($type === 'reset') {
                ...
                $title = EmailContent::resolveSecondaryEnglish($title, $titleBM, 'Reset your password', $tokens);
            ...
            if ($type === 'completion') {
                ...
                $body = EmailContent::resolveSecondaryEnglish($body, $bodyBM, 'Congratulations {{learner_name}} on completing {{course_title}} on {{platform_name}}.', $tokens);
                ...
                $emailTitleBM = EmailContent::get('course_completion_email_title_bm', 'Anda telah menyelesaikan sebuah kursus', $tokens);
                $emailTitle = EmailContent::resolveSecondaryEnglish($emailTitle, $emailTitleBM, 'You completed a course', $tokens);
